...
const PromotionsContent = ({ loading, error, promotions }: { loading: boolean, error: string | null, promotions: Promotion[] }) => {
    if (loading) {
  ...
  return (
    <section id="promociones" className="py-20 bg-pink-50">
      <div className="container mx-auto px-6">
        ...
        <PromotionsContent loading={loading} error={error} promotions={promotions} />
      </div>
    </section>
  );
};
